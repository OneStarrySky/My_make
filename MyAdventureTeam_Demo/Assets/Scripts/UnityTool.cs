...
public static class UnityTool
{
	...
	/// <returns></returns>
	public static T FindChildComponent<T>(GameObject Container, string gameobjectName)
	{
		return FindChildGameObject(Container, gameobjectName).GetComponent<T>();
	}

	public static void M_Debug(string str)
	{
		Debug.Log(str);
	}
}
